  ...
  return (
    ...
    >
      <div className="flex flex-row justify-start items-center ml-5 pl-6">
        ...
        />
        <span className=" pl-2 bg-gradient-to-b from-blue-400 to-blue-700 bg-clip-text text-3xl font-bold tracking-tighter text-transparent min-[375px]:bloc">
          100XCourses
        </span>
      </div>
      <div className="flex flex-row justify-center items-center">
        <div className="flex flex-row justify-between items-center p-5 gap-2">
          <svg
            ...
            className="lucide lucide-moon size-6 text-white"
          >
