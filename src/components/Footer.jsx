const Footer = () => {
  return (
    <section className="dark  bg-[#0a0b10] wrapper bottom-0 mx-auto flex w-full  flex-col items-center gap-2">
      <div className="mx-auto flex w-full flex-col justify-center gap-12 p-4 md:flex-row">
